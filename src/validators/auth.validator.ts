...
export default new (class V {
  registerValidator(): ValidationChain[] {
    return [
      check("firstName").notEmpty().withMessage("Enter your first name."),
      check("lastName").notEmpty().withMessage("Enter your first name."),
      check("phone").notEmpty().withMessage("Enter your phone number."),
      check("phone")
      ...
      check("password").custom((value:string) => {
